...
#include "../headers/content_pages.h"

void Page::o(const char *textoptions1, int op1,
...
void Page::setOptions(const char *textoptions1, int op1,
                      const char *textoptions2, int op2,
                      const char *textoptions3, int op3,
                      const char *textoptions4, int op4)
{
...
void Page::b(const char *text, int imageId, int customId)
{
    this->buildPage(text, imageId, customId);
};
void Page::buildPage(const char *text, * / int imageId, int customId)
{
    int i;
